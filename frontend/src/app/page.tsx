    ...
    <main className="min-h-screen">
      ...
      <section className="relative max-w-7xl mt-20 flex gap-20 mx-auto justify-between items-center h-[calc(100vh-160px)]">
        <div className="flex flex-col gap-6">
          <div className="flex bg-white bg-opacity-75 px-6 items-center gap-8 shadow-xl hover:shadow-2xl justify-center rounded-2xl py-4 max-w-fit">
            <Image src="/logo1.png" alt="logo" height={70} width={70} />
            <div className="text-6xl font-serif font-semibold">VTO</div>
          </div>
          <div className="flex bg-white bg-opacity-75 px-3 py-2 gap-3 shadow-xl hover:shadow-2xl rounded-2xl flex-col">
          ...
          <div className="flex bg-white bg-opacity-75 px-3 py-2 gap-3 shadow-xl hover:shadow-2xl rounded-2xl flex-col max-w-fit">
